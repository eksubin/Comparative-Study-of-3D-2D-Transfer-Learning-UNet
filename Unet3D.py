...
def unet3D(number_of_epoch=6, train_location="./Train"):
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric > best_metric:
                    ...
                    torch.save(model.state_dict(), os.path.join("./NetworkOutput", "best_metric_model1200.pth"))
    ...
    plt.plot(x, y)
    # Saving the figure.
    plt.savefig(os.path.join("./NetworkOutput", "modelPerformance.jpg"))


    model.load_state_dict(torch.load(
        os.path.join("./NetworkOutput", "best_metric_model1200.pth")))
    ...
    with torch.no_grad():
        for i, val_data in enumerate(val_loader):
            ...
            plt.savefig(os.path.join("./NetworkOutput", f"modelOutput{i}.jpg"))
